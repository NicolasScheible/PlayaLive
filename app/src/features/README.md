...
Feature-spezifischer Business-Logik: `auth/`, `home/` (Home Dashboard), `map/` (Live-Karte),
`locations/`, `events/`, `artists/`, `favorites/`, `reports/` (Community Reports inkl. Trust Score,
Geofencing), `specials/` (Specials & Happy Hours), `notifications/`, `weather/`.
