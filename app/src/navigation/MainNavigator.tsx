...
// Location-/Event-/Artist-Detail-Screens sowie die Favoriten-/Profil-/Community-Report-Screens (siehe
// docs/PRD.md Kapitel 10) über einen einfachen Stack — die endgültige Struktur (5-Tab-Bottom-Navigation
// mit zentralem Community-Report-Schnellzugriff, Hamburger-Drawer, siehe docs/PRD.md Kapitel 11,
// docs/Architecture.md Kapitel 7) wird erst mit den übrigen Tab-/Menü-Screens (Settings) umgesetzt. Der
// bisherige Demo-Logout-Platzhalter entfällt damit — „Abmelden" ist jetzt Teil des `ProfileScreen`
// (docs/PRD.md Kapitel 10), nicht mehr des Home Dashboards.
