...
// Haupt-App nach erfolgreichem Login. Zeigt Home Dashboard, Live-Karte, den vollständigen
// Location-Detail-Screen und den Event-Detail-Platzhalter (siehe docs/PRD.md Kapitel 10) über einen
// einfachen Stack — die endgültige Struktur (5-Tab-Bottom-Navigation mit
...
// diese nicht Teil des Location-Detail-Auftrags sind. Der bisherige Demo-Logout-Platzhalter entfällt
